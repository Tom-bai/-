    ...
    <div class="Commission">
        <div class="content">
            <div class="header">
                ...
                <div class="headerBtn" @click="shotP">提交</div>
            </div>
        </div>
        <van-dialog v-model="show" show-cancel-button confirm-button-text="确认提现" :before-close="beforeClose">
            <div class="showTixian">
                <div>
                    <p>委托金额</p>
                    <p><span class="num">{{entrustNum}}</span> {{Msgentrust.coinName}}</p>
                </div>
                <div>
                    <p>预计收益量</p>
                    <p><span class="num">{{shouyiNum}}</span> {{Msgentrust.coinName}}</p>
                </div>
            </div>
        </van-dialog>
    </div>
...
<script>
import Vue from 'vue'
import { Field,Cell,Dialog } from 'vant'
Vue.use(Dialog)
