<template>
    <div class="Quantification" :class="Commission?'hidden':''">
            ...
            <div class="content">
                ...
                <div class="contentBox">
                    <div class="contentH">
                        ...
                        <div class="tips noC" v-else>募资已结束</div>
                    </div>
                    <div class="contentT">
                    ...
                    <div class="navZ" v-if="HeaderBtnA === 1">
                        <div class="list">
                            ...
                            <div class="listItem">
                                ...
                                <div><span class="num">{{entrust.maxRetreat*100 | toFixedFour}}%</span></div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="BTN noC" v-else>委托已结束</div>
    </div>
</template>
...
export default {
    ...
    methods:{
        ...
        back() {
            Bus.$emit('QuantificationShow', false)
        },
        historyReportC() {
